...
\begin{table}[htbp]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \caption{Feature comparison of related architectural analysis tools. \checkmark\ indicates the feature is supported, $\times$\ indicates it is not supported. ''Partial'' indicates limited support. For MSANose, ''Partial'' means that the tool detects microservice-specific smells, but does not integrate a general intra-service smell catalogue such as DesigniteJava or use smell density as a health-score dimension.}
