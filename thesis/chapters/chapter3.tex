...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|c|p{6.5cm}|}
        ...
        \hline
        High & $-5$ per issue & Shared Database, God Service, Wrong Cuts, Chatty Service, ESB Misuse \\
        \hline
        Medium & $-3$ per issue & Nano Service, Hardcoded Endpoints, API Versioning Absence \\
        \hline
        Low & $-1$ per issue & --- \\
        \hline
    \end{tabular}
